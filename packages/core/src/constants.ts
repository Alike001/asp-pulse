export const LEGACY_RULE_SET_VERSION = 'PULSE-RULESET/1.0.0'
export const RULE_SET_VERSION = 'PULSE-RULESET/1.1.0'
...
export const X_LAYER_ASSET_METADATA = {
  [X_LAYER_ASSETS.USDG]: { symbol: 'USDG', decimals: 6 },
  [X_LAYER_ASSETS.USDT0]: { symbol: 'USDT0', decimals: 6 },
} as const
